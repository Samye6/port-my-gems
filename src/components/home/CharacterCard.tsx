...
const CharacterCard = ({
  ...
  const getBadgeStyles = () => {
    switch (badgeType) {
      ...
      case "vip":
        return "bg-gradient-to-r from-violet-500 to-pink-500 text-white shadow-[0_0_15px_rgba(139,92,246,0.5)]";
      default:
  ...
  return (
    /* Wrapper externe — porte le glow sans overflow-hidden */
    <div
      className={`relative flex-shrink-0 ${sizeClasses[size]}`}
      onMouseEnter={() => setIsHovered(true)}
      onMouseLeave={() => setIsHovered(false)}
    >
      {/* Glow externe diffus — rayonne AUTOUR de la carte, pas clippé */}
      <div
